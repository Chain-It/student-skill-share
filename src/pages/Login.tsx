...
import { Wallet, Briefcase, ShieldCheck, Zap, Users, GraduationCap } from 'lucide-react'; // Added relevant icons
...
export default function Login() {
  ...
  // Benefits list – realistic, student-focused
  const benefits = [
    {
      icon: Wallet,
      title: 'Earn on Your Terms',
      desc: 'Flexible gigs that fit around your lectures and exams.',
    },
    {
      icon: Briefcase,
      title: 'Build Real Experience',
      desc: 'Client projects that strengthen your CV and portfolio.',
    },
    {
      icon: ShieldCheck,
      title: 'Trusted & Secure',
      desc: 'Campus-verified users and secure Stripe payments.',
    },
    {
      icon: Zap,
      title: 'Quick Opportunities',
      desc: 'Fast tasks from fellow students and local businesses.',
    },
  ];
    ...
    <Layout hideFooter>
      <div className="min-h-screen relative overflow-hidden flex items-center justify-center py-12 px-4 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
        ...
        <div className="relative w-full max-w-6xl grid md:grid-cols-2 gap-12 items-center">
          {/* Left side: Benefits (hidden on mobile, appears below form on small screens) */}
          <motion.div
          ...
          >
            <div className="text-left">
              ...
              <p className="text-xl text-muted-foreground mt-4 max-w-md">
                Log in to access gigs, track earnings, and connect with campus opportunities.
              </p>
            </div>
          ...
          {/* Right side: Original form card (always visible) */}
          <motion.div
          ...
          >
            {/* Mobile header for benefits context */}
            <div className="md:hidden text-center mb-8">
              <span className="text-6xl">🎓</span>
              <h2 className="text-3xl font-bold mt-4 gradient-text">Welcome Back</h2>
            ...
            <Card>
              ...
              <CardContent>
                {/* Social login buttons - side by side at top */}
